@echo off
pyi-makespec --name "RPA_CLI" --icon "rpa_framework/ui/resources/favicon.ico" ^
       --add-data "config/*.json;config" ^
       --add-data "data/*.xlsx;data" ^
       --add-data "rpa_framework/robots/*.py;rpa_framework/robots" ^
       ...
       --hidden-import rpa_framework.utils.db_util ^
       --hidden-import rpa_framework.utils.email_util ^
       --hidden-import rpa_framework.utils.base64_decoder ^
       --hidden-import rpa_framework.robots.ah_related_party_trans ^
       --runtime-hook runtime_hook.py ^
       --exclude PySide6,PySide6.QtCore,PySide6.QtGui,PySide6.QtWidgets,PySide6.QtWebEngineWidgets,PySide6.QtWebEngineCore,matplotlib,scipy,PIL,tkinter,test,unittest ^
